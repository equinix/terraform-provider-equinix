...
func testSweepNetworkDevice(region string) error {
	...
	devices, err := config.NEClient.GetDevices([]string{
	...
	for _, device := range devices {
		if !tfacc.IsSweepableTestResource(ne.StringValue(device.Name)) {
			nonSweepableCount++
			continue
		}
		...
		if err := config.NEClient.DeleteDevice(ne.StringValue(device.UUID)); err != nil {
...
func TestAccNetworkDevice_CSR1000V_HA_Managed_Sub(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"device-byol":                    false,
		"device-name":                    fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		...
		"device-secondary_name":          fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		...
		"user-username":                  fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		"user-password":                  acctest.RandString(10),
	}

	contextWithACLs := maps.CopyMap(context)
	contextWithACLs["acl-resourceName"] = "acl-pri"
	contextWithACLs["acl-name"] = fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6))
	contextWithACLs["acl-description"] = acctest.RandString(50)
	contextWithACLs["acl-secondary_resourceName"] = "acl-sec"
	contextWithACLs["acl-secondary_name"] = fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6))
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice, withSSHUser).Build(),
			...
			{
				Config: tfacc.NewTestAccConfig(contextWithACLs, withDevice,
...
func TestAccNetworkDevice_CSR1000V_HA_Self_BYOL(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"sshkey-name":                    fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice, withSSHKey).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, context),
...
func TestAccNetworkDevice_vSRX_HA_Managed_Sub(t *testing.T) {
	...
	contextWithChanges := maps.CopyMap(context)
	contextWithChanges["user-resourceName"] = "test"
	contextWithChanges["user-username"] = fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6))
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, context),
					testAccNeDeviceStatusAttributes(&primary, ne.DeviceStateProvisioned, ne.DeviceLicenseStateRegistered),
			...
			{
				Config: tfacc.NewTestAccConfig(contextWithChanges, withDevice, withSSHUser).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
...
func TestAccNetworkDevice_vSRX_HA_Managed_BYOL(t *testing.T) {
	metro, _ := schema.EnvDefaultFunc(tfacc.NEDeviceMetroEnvVar, "SV")()
	accountName, _ := schema.EnvDefaultFunc(tfacc.NEDeviceAccountNameEnvVar, "")()
	licenseFile, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVSRXLicenseFileEnvVar, "")()
	...
	context := map[string]interface{}{
		...
		"acl-name":                       fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		"acl-description":                acctest.RandString(50),
		"acl-secondary_resourceName":     "acl-sec",
		"acl-secondary_name":             fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		"acl-secondary_description":      acctest.RandString(50),
	}

	contextWithChanges := maps.CopyMap(context)
	contextWithChanges["device-name"] = fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6))
	...
	contextWithChanges["device-secondary_name"] = fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6))
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice, withACL).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, context),
					testAccNeDeviceStatusAttributes(&primary, ne.DeviceStateProvisioned, ne.DeviceLicenseStateRegistered),
			...
			{
				Config: tfacc.NewTestAccConfig(contextWithChanges, withDevice, withACL, withSSHUser).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, contextWithChanges),
					testAccNeDeviceStatusAttributes(&primary, ne.DeviceStateProvisioned, ne.DeviceLicenseStateRegistered),
...
func TestAccNetworkDevice_vSRX_HA_Self_BYOL(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice, withACL, withSSHKey).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, context),
					testAccNeDeviceStatusAttributes(&primary, ne.DeviceStateProvisioned, ne.DeviceLicenseStateApplied),
...
func TestAccNetworkDevice_PaloAlto_HA_Self_BYOL(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: tfacc.NewTestAccConfig(contextWithACLs, withDevice, withSSHKey, withACL).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNetworkACLTemplateExists(priACLResourceName, &primaryACL),
					testAccNetworkACLTemplateExists(secACLResourceName, &secondaryACL),
					testAccNeDeviceExists(deviceResourceName, &primary),
...
func TestAccNetworkDevice_CSRSDWAN_HA_Self_BYOL(t *testing.T) {
	metro, _ := schema.EnvDefaultFunc(tfacc.NEDeviceMetroEnvVar, "SV")()
	accountName, _ := schema.EnvDefaultFunc(tfacc.NEDeviceAccountNameEnvVar, "")()
	licFile, _ := schema.EnvDefaultFunc(tfacc.NEDeviceCSRSDWANLicenseFileEnvVar, "test-fixtures/CSRSDWAN.cfg")()
	context := map[string]interface{}{
		"device-resourceName":                           "test",
		"device-account_name":                           accountName.(string),
		"device-self_managed":                           true,
...
func TestAccNetworkDevice_Versa_HA_Self_BYOL(t *testing.T) {
	metro, _ := schema.EnvDefaultFunc(tfacc.NEDeviceMetroEnvVar, "SV")()
	accountName, _ := schema.EnvDefaultFunc(tfacc.NEDeviceAccountNameEnvVar, "")()
	controller1, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVersaController1EnvVar, "1.1.1.1")()
	controller2, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVersaController2EnvVar, "2.2.2.2")()
	localID, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVersaLocalIDEnvVar, "test@versa.com")()
	remoteID, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVersaRemoteIDEnvVar, "test@versa.com")()
	serialNumber, _ := schema.EnvDefaultFunc(tfacc.NEDeviceVersaSerialNumberEnvVar, "Test")()
	context := map[string]interface{}{
		"device-resourceName":                        "test",
		"device-account_name":                        accountName.(string),
		"device-self_managed":                        true,
...
func TestAccNetworkDevice_CGENIX_HA_Self_BYOL(t *testing.T) {
	metro, _ := schema.EnvDefaultFunc(tfacc.NEDeviceMetroEnvVar, "SV")()
	accountName, _ := schema.EnvDefaultFunc(tfacc.NEDeviceAccountNameEnvVar, "")()
	licenseKey, _ := schema.EnvDefaultFunc(tfacc.NEDeviceCGENIXLicenseKeyEnvVar, acctest.RandString(10))()
	licenseSecret, _ := schema.EnvDefaultFunc(tfacc.NEDeviceCGENIXLicenseSecretEnvVar, acctest.RandString(10))()
	context := map[string]interface{}{
		"device-resourceName":                         "test",
		"device-account_name":                         accountName.(string),
		"device-self_managed":                         true,
...
func TestAccNetworkDevice_PaloAlto_Cluster_Self_BYOL(t *testing.T) {
	metro, _ := schema.EnvDefaultFunc(tfacc.NEDeviceMetroEnvVar, "SV")()
	accountName, _ := schema.EnvDefaultFunc(tfacc.NEDeviceAccountNameEnvVar, "")()
	licenseToken, _ := schema.EnvDefaultFunc(tfacc.NEDevicePANWLicenseTokenEnvVar, "")()
	context := map[string]interface{}{
		"device-resourceName":                "test",
		"device-account_name":                accountName.(string),
		"device-self_managed":                true,
		...
		"device-core_count":                  2,
		"device-cluster_name":                fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
		...
		"mgmtAcl-name":                       fmt.Sprintf("%s-%s", tfacc.TestResourcePrefix, acctest.RandString(6)),
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tfacc.NewTestAccConfig(context, withDevice, withSSHKey, withACL).Build(),
				Check: resource.ComposeTestCheckFunc(
					testAccNeDeviceExists(deviceResourceName, &primary),
					testAccNeDeviceAttributes(&primary, context),
					testAccNeDeviceStatusAttributes(&primary, ne.DeviceStateProvisioned, ne.DeviceLicenseStateApplied),
...
func withDevice(t *tfacc.TestAccConfig) {
	t.Use(testAccNetworkDevice)
}

func withACL(t *tfacc.TestAccConfig) {
	t.Use(testAccNetworkDeviceACL)
}

func withSSHKey(t *tfacc.TestAccConfig) {
	t.Use(testAccNetworkDeviceSSHKey)
}
