...
import (
	...
	ecx "github.com/equinix/ecx-go/v2"
...
func TestFabricL2Connection_updateResourceData(t *testing.T) {
	...
	assert.Equal(t, input.Notifications, converters.ExpandSetToStringList(d.Get(ecxL2ConnectionSchemaNames["Notifications"]).(*schema.Set)), "Notifications matches")
