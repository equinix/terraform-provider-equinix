...
func resourceMetalVirtualCircuitCreate(d *schema.ResourceData, meta interface{}) error {
	...
	tags := d.Get("tags.#").(int)
	if tags > 0 {
		vncr.Tags = converters.ConvertStringArr(d.Get("tags").([]interface{}))
	}
...
func resourceMetalVirtualCircuitUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("tags") {
		...
		case []interface{}:
			...
			ur.Tags = &sts
		default:
			return errors.FriendlyError(fmt.Errorf("garbage in tags: %s", ts))
		}
	}
...
func resourceMetalVirtualCircuitDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if errors.IgnoreResponseErrors(errors.HttpForbidden, errors.HttpNotFound)(nil, err) != nil {
