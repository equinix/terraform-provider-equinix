 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ServiceTokensApiGetAllServiceTokensOpts - Optional Parameters:
     * @param "Offset" (optional.Float64) -  offset
     * @param "Limit" (optional.Float64) -  number of records to fetch
@return ServiceTokens
*/

type ServiceTokensApiGetAllServiceTokensOpts struct {
	Offset optional.Float64
	Limit  optional.Float64
}

func (a *ServiceTokensApiService) GetAllServiceTokens(ctx context.Context, localVarOptionals *ServiceTokensApiGetAllServiceTokensOpts) (ServiceTokens, *http.Response, error) {
	var (
