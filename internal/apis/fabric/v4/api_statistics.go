...
@return Statistics
*/
func (a *StatisticsApiService) GetStatsByPortUUID(ctx context.Context, portId string, startDateTime time.Time, endDateTime time.Time) (Statistics, *http.Response, error) {
	var (
...
@return Statistics
*/
func (a *StatisticsApiService) GetStatsByVcUUID(ctx context.Context, connectionId string, startDateTime time.Time, endDateTime time.Time, viewPoint ViewPoint) (Statistics, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param optional nil or *StatisticsApiGetTopUtilizedPortStatisticsOpts - Optional Parameters:
...
type StatisticsApiGetTopUtilizedPortStatisticsOpts struct {
...
func (a *StatisticsApiService) GetTopUtilizedPortStatistics(ctx context.Context, metros []string, localVarOptionals *StatisticsApiGetTopUtilizedPortStatisticsOpts) (TopUtilizedStatistics, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
