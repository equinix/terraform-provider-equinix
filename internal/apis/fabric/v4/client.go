...
// APIClient manages communication with the Equinix Fabric API v4 API v4.2
...
type APIClient struct {
	...
	RouteTableEntriesApi *RouteTableEntriesApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RouteTableEntriesApi = (*RouteTableEntriesApiService)(&c.common)
