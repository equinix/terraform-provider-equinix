 ...
 * @param body
 * @param connectionId Connection Id
 * @param optional nil or *RoutingProtocolsApiCreateConnectionRoutingProtocolBulkOpts - Optional Parameters:
     * @param "XCORRELATIONID" (optional.String) -  Correlation identifier
     * @param "XAUTHUSERNAME" (optional.String) -  User name
     * @param "XSOURCE" (optional.String) -  source
@return GetResponse
...
type RoutingProtocolsApiCreateConnectionRoutingProtocolBulkOpts struct {
	XCORRELATIONID optional.String
	XAUTHUSERNAME  optional.String
	XSOURCE        optional.String
}

func (a *RoutingProtocolsApiService) CreateConnectionRoutingProtocolBulk(ctx context.Context, body ConnectionRoutingProtocolPostRequest, connectionId string, localVarOptionals *RoutingProtocolsApiCreateConnectionRoutingProtocolBulkOpts) (GetResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param connectionId Connection Id
 * @param optional nil or *RoutingProtocolsApiDeleteConnectionRoutingProtocolOpts - Optional Parameters:
     * @param "XCORRELATIONID" (optional.String) -  Correlation identifier
     * @param "XAUTHUSERNAME" (optional.String) -  User name
     * @param "XSOURCE" (optional.String) -  source
@return RoutingProtocolData
...
type RoutingProtocolsApiDeleteConnectionRoutingProtocolOpts struct {
	XCORRELATIONID optional.String
	XAUTHUSERNAME  optional.String
	XSOURCE        optional.String
}

func (a *RoutingProtocolsApiService) DeleteConnectionRoutingProtocol(ctx context.Context, routingProtocolId string, connectionId string, localVarOptionals *RoutingProtocolsApiDeleteConnectionRoutingProtocolOpts) (RoutingProtocolData, *http.Response, error) {
	var (
 ...
 * @param routingProtocolId Routing Protocol Id
 * @param connectionId Connection Id
 * @param optional nil or *RoutingProtocolsApiGetConnectionRoutingProtocolOpts - Optional Parameters:
     * @param "XCORRELATIONID" (optional.String) -  Correlation identifier
     * @param "XAUTHUSERNAME" (optional.String) -  User name
     * @param "XSOURCE" (optional.String) -  source
@return RoutingProtocolData
...
type RoutingProtocolsApiGetConnectionRoutingProtocolOpts struct {
	XCORRELATIONID optional.String
	XAUTHUSERNAME  optional.String
	XSOURCE        optional.String
}

func (a *RoutingProtocolsApiService) GetConnectionRoutingProtocol(ctx context.Context, routingProtocolId string, connectionId string, localVarOptionals *RoutingProtocolsApiGetConnectionRoutingProtocolOpts) (RoutingProtocolData, *http.Response, error) {
	var (
