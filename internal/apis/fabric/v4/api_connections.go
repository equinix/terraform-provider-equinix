...
@return Connection
*/
func (a *ConnectionsApiService) ActionByConnectionUUID(ctx context.Context, body ConnectionActionRequest, connectionId string) (Connection, *http.Response, error) {
	var (
...
*/
func (a *ConnectionsApiService) CreateBulkConnection(ctx context.Context, body ConnectionBulkPostRequest) (ConnectionBulk, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ConnectionsApiService) GetConnectionByUuid(ctx context.Context, connectionId string, localVarOptionals *ConnectionsApiGetConnectionByUuidOpts) (Connection, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/fabric/v4/connections/{connectionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"connectionId"+"}", fmt.Sprintf("%v", connectionId), -1)
	fmt.Println(" Local Var Path with value", localVarPath)
	localVarHeaderParams := make(map[string]string)
	fmt.Println(" Local Var header params ", localVarHeaderParams)
	localVarQueryParams := url.Values{}
	fmt.Println(" Local Var query params ", localVarQueryParams)

	localVarFormParams := url.Values{}
	fmt.Println(" Local Var form params ", localVarFormParams)
...
*/
func (a *ConnectionsApiService) ValidateByAuthKey(ctx context.Context, body ValidateByAuthKeyPostRequest) (ConnectionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
