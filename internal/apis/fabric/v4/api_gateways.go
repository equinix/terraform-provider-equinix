...
*/
func (a *GatewaysApiService) GatewayAction(ctx context.Context, body GatewayActionRequest, gatewayId string) (GatewayActionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
*/
func (a *GatewaysApiService) GetGatewayPackageDetails(ctx context.Context, gatewayPackageCode GatewayPackageCode) (VirtualGatewayPackage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
