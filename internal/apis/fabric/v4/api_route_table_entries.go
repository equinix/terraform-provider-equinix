...
/*
RouteTableEntriesApiService Search Route Table
...
*/
func (a *RouteTableEntriesApiService) SearchRouteTableEntries(ctx context.Context, body RouteTableEntrySearchRequest, gatewayId string) (RouteTableEntrySearchResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/fabric/v4/gateways/{gatewayId}/routeTableEntries/search"
