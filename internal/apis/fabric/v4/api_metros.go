 ...
 * @param optional nil or *MetrosApiGetMetroOpts - Optional Parameters:
     * @param "CorrelationId" (optional.String) -  Correlation identifier
@return Metro
*/

type MetrosApiGetMetroOpts struct {
	CorrelationId optional.String
}

func (a *MetrosApiService) GetMetro(ctx context.Context, metroCode string, localVarOptionals *MetrosApiGetMetroOpts) (Metro, *http.Response, error) {
	var (
