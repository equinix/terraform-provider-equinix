 ...
 * @param optional nil or *RoutesApiSearchRoutesOpts - Optional Parameters:
...
type RoutesApiSearchRoutesOpts struct {
	XCORRELATIONID optional.String
	XAUTHUSERNAME  optional.String
	XSOURCE        optional.String
}

func (a *RoutesApiService) SearchRoutes(ctx context.Context, body RouteTableEntrySearchRequest, gatewayId string, localVarOptionals *RoutesApiSearchRoutesOpts) (RouteTableEntrySearchResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/fabric/v4/gateways/{gatewayId}/routes/search"
