...
*/
func (a *ServiceProfilesApiService) CreateServiceProfile(ctx context.Context, body ServiceProfileRequest, icVersion string) (ServiceProfile, *http.Response, error) {
	var (
...
@return ServiceProfile
*/
func (a *ServiceProfilesApiService) DeleteServiceProfileByUuid(ctx context.Context, serviceProfileId string, icVersion string) (ServiceProfile, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ServiceProfilesApiPutServiceProfileByUuidOpts - Optional Parameters:
     * @param "IfMatch" (optional.String) -  conditional request
@return ServiceProfile
*/
...
func (a *ServiceProfilesApiService) PutServiceProfileByUuid(ctx context.Context, body ServiceProfileRequest, icVersion string, serviceProfileId string, localVarOptionals *ServiceProfilesApiPutServiceProfileByUuidOpts) (ServiceProfile, *http.Response, error) {
	var (
...
@return ServiceProfiles
*/
func (a *ServiceProfilesApiService) SearchServiceProfiles(ctx context.Context, body ServiceProfileSearchRequest, icVersion string) (ServiceProfiles, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ServiceProfilesApiService) UpdateServiceProfileByUuid(ctx context.Context, body []JsonPatchOperation, icVersion string, serviceProfileId string, localVarOptionals *ServiceProfilesApiUpdateServiceProfileByUuidOpts) (ServiceProfile, *http.Response, error) {
	var (
