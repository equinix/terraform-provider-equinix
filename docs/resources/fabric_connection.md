...
- `redundancy` (Block Set, Max: 1) Connection Redundancy Configuration (applicable only for Azure connections) (see [below for nested schema](#nestedblock--redundancy))
