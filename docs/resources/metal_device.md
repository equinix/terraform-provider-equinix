...
- `storage` (String) JSON for custom partitioning. Only usable on reserved hardware. More information in in the [Custom Partitioning and RAID](https://docs.equinix.com/metal/servers/custom-partitioning-raid/) doc
...
- `network_type` (String, Deprecated) Network type of a device, used in [Layer 2 networking](https://docs.equinix.com/metal/networking/layer2/). Will be one of layer3, hybrid, hybrid-bonded, layer2-individual, layer2-bonded
