...
Provides a resource to manage BGP sessions in Equinix Metal Host. Refer to [Equinix Metal BGP documentation](https://docs.equinix.com/metal/bgp/bgp-on-equinix-metal/) for more details.
