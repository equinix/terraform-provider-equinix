...
Provides a resource to manage BGP sessions in Equinix Metal Host. Refer to [Equinix Metal BGP documentation](https://docs.equinix.com/metal/networking/local-global-bgp/) for more details.
