...
* `redundancy_type` - (Optional) Whether the connection should be created through Fabric's primary or secondary port.Supported values: PRIMARY, SECONDARY, HYBRID
