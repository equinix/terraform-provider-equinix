...
In April 2021, [Equinix Metal](https://docs.equinix.com/metal/) rolled out a new location concept - [metros](https://docs.equinix.com/metal/locations/metros/). A metro is an Equinix-wide concept for data centers which are grouped together geographically. Data centers within a metro share capacity and networking features. You can read more about metros at https://docs.equinix.com/metal/locations/metros/. In April 2023, [facility deployment was deprecated](https://docs.equinix.com/metal/locations/facilities/) with metro provisioning offered as an all-around superior deployment strategy. See the [facilities guide in the Metal API docs](https://docs.equinix.com/metal/locations/facilities/) for more details about the API change.
