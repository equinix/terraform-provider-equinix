...
To have any BGP neighbors listed, the device must be in [BGP-enabled project](../resources/metal_project.md) and have a [BGP session](../resources/metal_bgp_session.md) assigned.

To learn more about using BGP in Equinix Metal, see the [equinix_metal_bgp_session](../resources/metal_bgp_session.md) resource documentation.
