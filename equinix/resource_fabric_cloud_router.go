...
func resourceFabricCloudRouterCreate(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	if _, err = waitUntilCloudRouterIsProvisioned(d.Id(), meta, d, ctx); err != nil {
...
func resourceFabricCloudRouterUpdate(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	client := meta.(*config.Config).NewFabricClientForSDK(d)
	dbConn, err := waitUntilCloudRouterIsProvisioned(d.Id(), meta, d, ctx)
	if err != nil {
		if !strings.Contains(err.Error(), "500") {
			d.SetId("")
		}
	...
	updateCloudRouter, err := waitForCloudRouterUpdateCompletion(d.Id(), meta, d, ctx)
...
func waitForCloudRouterUpdateCompletion(uuid string, meta interface{}, d *schema.ResourceData, ctx context.Context) (*fabricv4.CloudRouter, error) {
...
func waitUntilCloudRouterIsProvisioned(uuid string, meta interface{}, d *schema.ResourceData, ctx context.Context) (fabricv4.CloudRouter, error) {
...
func resourceFabricCloudRouterDelete(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	err = WaitUntilCloudRouterDeprovisioned(d.Id(), meta, d, ctx)
	if err != nil {
...
func WaitUntilCloudRouterDeprovisioned(uuid string, meta interface{}, d *schema.ResourceData, ctx context.Context) error {
